...
import '@whcg/whcg-lit-tab/theme/whcg-lit-tabs-styles.js';
import '@whcg/whcg-lit-tab/theme/whcg-lit-tab-styles.js';
...
class WhcgLitTab extends PolymerElement {
  static get template() {
    return html`
        ...
        <vaadin-tabs orientation="vertical" selected="{{page}}"><vaadin-tab>VAL ETT</vaadin-tab><vaadin-tab>VAL TVÅ</vaadin-tab><vaadin-tab>VAL TRE</vaadin-tab><vaadin-tab>VAL FYRA</vaadin-tab></vaadin-tabs>
    `;
  }
