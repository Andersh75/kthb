...
_prevBatch() {
  ...
  _maintableitemsChanged() {
    ...
    _selectedColumnChanged(selectedColumnsIdOld, selectedColumnsArrOld, res) {
            console.log('top');
            console.log(selectedColumnsArrOld);
            ...
            console.log(newArrIdsName.length);
            console.log('selectedColumnsIdOld.length');
            console.log(selectedColumnsIdOld.length);
        ...
        console.log('selectedColumnsIdOld');
        console.log(selectedColumnsIdOld);
        ...
        console.log(this.maintableitems);
            this.maintableitems = [];
            this.maintableitems = this.totalList;
            ...
            <div class="col1span12 grid-12 main">
                ...
                <div id="commonsection" class="col1span12">
                    <whcg-section-wide-chartlong>
                        ...
                        <whcg-lit-grid  id="grid" slot="chart" selecteditems="{{selectedmain}}" page-size="10" height-by-rows>
